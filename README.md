...
This repository contains the codes used for the pre-printed paper available at \[[arXiv:2108.09394](https://arxiv.org/abs/2108.09394)\]: 
...
Outputs of `out-03.jpg`, `out-04.jpg`, and `out-05.jpg` from input folder `75` can be different depending on `-t` as shown below: 
  ...
  - Obviously, the higher `-t` highlights larger areas, whereas the smaller only allows for the highly impactful local motion, which is around *dueling* in this example, observed on the central region.  
